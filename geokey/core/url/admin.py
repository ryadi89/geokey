...
urlpatterns = [
    ...
    url(r'^superuser-tools/providers/install/$',
        superusertools.ProviderInstall.as_view(),
        name='superusertools_provider_install'),
    url(r'^superuser-tools/providers/(?P<provider_id>[0-9]+)/$',
        superusertools.ProviderSettings.as_view(),
        name='superusertools_provider_settings'),
    url(r'^superuser-tools/providers/(?P<provider_id>[0-9]+)/delete/$',
