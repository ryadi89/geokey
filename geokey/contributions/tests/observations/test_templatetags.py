...
class TemplateTagsTest(TestCase):
    ...
    def test_description(self):
        ...
        self.assertEqual(
            ...
            '<table><tr><td><strong>Image</strong><br /><a href="/media/image.png"><img src="/media/image-thumbnail.png" alt="" /></a></td></tr>'
            '<tr><td><strong>Video</strong><br /><a href="https://www.youtube.com/watch?v=LueGR1IpfS0"><img src="/static/img/play.png" alt="" /></a></td></tr>'
